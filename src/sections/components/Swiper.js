      ...
      >
        <SwiperSlide style={{position: 'relative'}}>
            <Container fluid className="p-0 font" id='image' style={{backgroundImage: 'url("https://images.unsplash.com/photo-1646022665170-72000e70a034?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2825&q=80")', backgroundSize: 'cover', backgroundPosition: 'center',}}>
              ...
              <h3 style={{color: 'white', fontFamily: "Inika, serif"}}>Cane Corso Resources</h3>
              <Container className="p-0 mt-2">
                ...
                <a href="https://www.canecorsoresources.co" target='_blank' style={{fontFamily: "Inika, serif"}}><Button variant="outline-success">View Live Site</Button></a>
              </Container>  
              </Container>
            </Container>
        </SwiperSlide>
        <SwiperSlide>
            ...
            <Container style={{backgroundColor: 'black', zIndex: '100', width: '60%', opacity: '0.6', height: '100%', position: 'absolute'}}>
              <h3 style={{color: 'white', fontFamily: "Inika, serif"}}>Altered NWLA</h3>
              <Container className="p-0 mt-2">
                ...
                <a href="https://www.alterednwla.org" target='_blank' style={{fontFamily: "Inika, serif"}}><Button variant="outline-success">View Live Site</Button></a>
              </Container>  
              </Container>
            </Container>   
        </SwiperSlide>
        <SwiperSlide>
            ...
            <Container style={{backgroundColor: 'black', zIndex: '100', width: '60%', opacity: '0.6', height: '100%', position: 'absolute'}}>
              <h3 style={{color: 'white', fontFamily: "Inika, serif"}}>Blak Kontroller</h3>
              <Container className="p-0 mt-2">
                <p style={{color: 'white'}}>Blak Kontroller is a online tool that helps users find free online PC games to play.</p>
                <a href="https://www.blakkontroller.com" target='_blank' style={{fontFamily: "Inika, serif"}}><Button variant="outline-success">View Live Site</Button></a>
              </Container>  
              </Container>
            </Container>   
        </SwiperSlide>
